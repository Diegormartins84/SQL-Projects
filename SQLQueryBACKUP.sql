-- Visualização dos dados das tabelas de carga
...
-- Quais clientes fizeram um pedido? (entender o comportamento dos pedidos)
...
--Abra o excel e clique em ObterDados, Do Banco De Dados, Do Banco De Dados SQL Server
--Preecher com seu banco de dados
